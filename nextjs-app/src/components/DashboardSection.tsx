...
const GAUGES = [
  { id: 'speed', label: 'SPEED', unit: 'm/s', value: 12.4, max: 16, color: '#e0231f', pct: 77 },
  { id: 'power', label: 'POWER', unit: 'kW', value: 4.2, max: 6, color: '#00A3FF', pct: 70 },
  { id: 'force', label: 'FORCE', unit: 'N', value: 847, max: 1200, color: '#e0231f', pct: 71 },
    ...
    <section ref={sectionRef} id="dashboard" className="relative bg-apex-black py-24 md:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute top-0 left-0 right-0 h-px" style={{
          background: 'linear-gradient(90deg, transparent, rgba(224,35,31,0.25) 30%, rgba(224,35,31,0.25) 70%, transparent)'
        }} />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        >
          RACE-GRADE<br /><span className="text-apex-red">TELEMETRY</span>
        </motion.h2>
          ...
          <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 flex flex-col gap-5">
              ...
              <div className="bg-apex-black/60 rounded-xl p-4 border border-apex-line/50">
                <LiveChart color="#e0231f" label="Velocity (m/s)" inView={inView} />
              </div>
