    ...
    <section id="how" className="relative bg-apex-black py-24 md:py-36 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute left-1/2 top-1/3 -translate-x-1/2 w-[80vw] h-[60vh]" style={{
          background: 'radial-gradient(ellipse 50% 50% at 50% 50%, rgba(123,47,190,0.06), transparent 65%)'
        }} />
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        <div ref={titleRef} className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-16 items-end">
          ...
          >
            SIMPLE TO APPLY.<br />
            <span className="text-apex-purple">POWERFUL IN EFFECT.</span>
          </motion.h2>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          ...
          <div className="hidden md:block absolute top-[38px] left-[16%] right-[16%] h-px pointer-events-none"
            style={{ background: 'linear-gradient(90deg, rgba(123,47,190,0.5), rgba(123,47,190,0.2), rgba(123,47,190,0.5))' }}
            aria-hidden="true"
          />
          {STEPS.map((step, i) => (
        ...
        >
          <p className="font-display font-black text-apex-white leading-tight"
            ...
            <span className="text-apex-purple">It is about giving coaches a better system for better outcomes.</span>
          </p>
        </motion.div>
      </div>
    </section>
...
function StepCard({
  ...
  return (
    <motion.div
      className="group relative bg-apex-panel border border-apex-line p-7 overflow-hidden hover:border-apex-purple/30 transition-colors duration-300 cursor-default"
      style={{ borderRadius: 0, borderTop: '2px solid rgba(123,47,190,0.55)' }}
    ...
    >
      ...
      <div
        ...
        style={{ background: 'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(123,47,190,0.07), transparent)' }}
      />

      {/* Step number medallion */}
      <div className="relative mb-5">
        <div
          className="w-[52px] h-[52px] flex items-center justify-center bg-apex-black border border-apex-purple/40"
          style={{ boxShadow: '0 0 24px -8px rgba(123,47,190,0.5)' }}
        >
          <span className="font-display font-black text-apex-purple text-lg">{step.num}</span>
        </div>
      </div>
