...
export default function HowItWorksSection() {
  ...
  return (
    <section id="how" className="relative bg-apex-black py-16 md:py-36 overflow-hidden">
      {/* Top rule */}
      <div
      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-10 lg:px-16">
        ...
        {/* Supporting line */}
        <motion.div
          className="mt-10 md:mt-16 pt-10 border-t border-apex-line/40 max-w-3xl mx-auto text-center"
