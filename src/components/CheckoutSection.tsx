        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_1fr] gap-10 lg:gap-14 items-start">
          ...
          <div className="order-1 lg:order-2 flex flex-col lg:sticky lg:top-24">
            ...
            <button
              ...
              className="group cta-gold flex items-stretch w-full cursor-pointer text-left"
              style={{ borderRadius: 0 }}
            >
              {/* Gold chevron plate + cart */}
              <span className="cta-gold-chevron flex items-center justify-center pl-5 pr-7 my-1 ml-1 flex-shrink-0" aria-hidden="true">
                <svg className="w-7 h-7 sm:w-8 sm:h-8 text-[#2a1f05] transition-transform duration-300 group-hover:scale-105" fill="none" viewBox="0 0 24 24" strokeWidth={1.7} stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z" />
                </svg>
              </span>

              {/* Wordmark + sub-line */}
              <span className="flex flex-col items-center justify-center gap-1 flex-1 px-4 py-4 sm:py-5">
                <span className="t-gold-cta font-display font-black tracking-[0.1em] uppercase text-[19px] sm:text-[23px] leading-none">
                  Add to Cart
                </span>
                <span className="font-mono text-[10px] sm:text-[11px] tracking-[0.16em] uppercase text-[#c9ad6a] font-normal text-center leading-snug">
