    ...
    <section id="australia" className="relative overflow-hidden py-28 sm:py-36">
      ...
      <div className="relative mx-auto max-w-7xl px-5 sm:px-10">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <p className="flex items-center gap-3 font-mono text-xs uppercase tracking-[0.3em] text-cyan/80">
            <span className="inline-block h-3 w-3 rotate-45 bg-cyan" /> Made for here
          </p>
        ...
        <div className="mt-14 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {AU_SPORTS.map((s, i) => (
            ...
            >
              <div className="pointer-events-none absolute -right-6 -top-6 font-display text-7xl font-bold text-white/[0.04] transition-colors group-hover:text-cyan/10">
                {s.code}
              </div>
              <div className="absolute inset-x-0 bottom-0 h-px w-0 bg-gradient-to-r from-electric to-cyan transition-all duration-500 group-hover:w-full" />
