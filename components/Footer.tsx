      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-8 md:flex-row md:items-center md:justify-between">
        <div>
          <p className="font-display text-xl font-bold tracking-[0.16em]">
            T<span className="text-cyan">·</span>APEX <span className="text-cyan/70">AUSTRALIA</span>
          </p>
        ...
        <nav className="flex flex-wrap gap-x-8 gap-y-2 font-mono text-xs uppercase tracking-[0.16em] text-white/50">
          <a href="#technology" className="hover:text-cyan">Technology</a>
          <a href="#how" className="hover:text-cyan">How It Works</a>
          <a href="#product" className="hover:text-cyan">Product</a>
          <a href="#australia" className="hover:text-cyan">Australia</a>
          <a href="#contact" className="hover:text-cyan">Book Demo</a>
        </nav>
      </div>
