    ...
    <section className="relative overflow-hidden py-28 sm:py-36">
      <div className="mx-auto max-w-7xl px-5 sm:px-10">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-cyan/80">Trusted At The Top</p>
              ...
              */}
              <div className="relative aspect-video overflow-hidden bg-gradient-to-br from-steel to-black">
                ...
                <div className="absolute inset-0 grid place-items-center">
                  <span className="grid h-14 w-14 place-items-center rounded-full border border-cyan/40 text-cyan transition-transform group-hover:scale-110">
                    ▶
                  </span>
                </div>
                <div className="absolute inset-x-0 top-0 h-px animate-scanline bg-gradient-to-r from-transparent via-cyan/60 to-transparent" />
              ...
              <figcaption className="glass flex flex-1 flex-col justify-between p-6">
                ...
                <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.2em] text-cyan/80">
        ...
        <div className="mt-10 grid grid-cols-2 gap-px overflow-hidden rounded-2xl border border-white/5 bg-white/5 sm:grid-cols-4">
          {[
            ...
            <div key={m.k} className="bg-black p-6 text-center">
              <p className="font-display text-2xl font-semibold text-cyan sm:text-3xl">{m.v}</p>
