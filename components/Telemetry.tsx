    ...
    <section id="technology" className="relative overflow-hidden py-28 sm:py-36">
      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-10">
        <motion.div
          ...
          className="max-w-2xl"
        >
          <p className="font-mono text-xs uppercase tracking-[0.3em] text-red/80">Live Telemetry</p>
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-[1.6fr_1fr]">
          ...
          <div className="glass relative overflow-hidden rounded-2xl p-6">
            ...
            <svg viewBox="0 0 600 280" className="h-auto w-full">
              ...
              {/* acceleration curve (rises and plateaus) — primary brand red */}
              <Curve d="M0,260 C120,250 180,120 280,70 C360,32 480,30 600,26" color="#ff2d2d" />
              {/* power curve — telemetry blue (data accent) */}
              <Curve d="M0,270 C140,230 220,180 320,150 C420,120 520,135 600,110" color="#3b82f6" delay={0.3} />
              {/* resistance zone — neutral white */}
              <Curve d="M0,200 C120,200 160,160 280,160 C420,160 480,190 600,150" color="#c9ccd2" delay={0.6} />
            </svg>
            <div className="mt-4 flex flex-wrap gap-5 font-mono text-[11px] text-white/60">
              <span className="flex items-center gap-2"><i className="h-2 w-2 rounded-full bg-red" />Speed</span>
              <span className="flex items-center gap-2"><i className="h-2 w-2 rounded-full bg-telemetry" />Power</span>
              <span className="flex items-center gap-2"><i className="h-2 w-2 rounded-full bg-white/70" />Resistance</span>
            </div>
          </div>
          ...
          <div className="grid gap-6">
            {READOUTS.map((r, i) => (
              ...
              >
                <p className="font-mono text-[11px] tracking-[0.22em] text-red/80">{r.k}</p>
